...
<script>
import { DISPOSITION } from "@/views/opinionAnalysis/topic/data.js";
  ...
  methods: {
    ...
    getTableData() {
      ...
      let payload = {
        ...
        from: this.cardConfigs.from,
      };

      const action = this.datas?.tableAction
        ? this.datas.tableAction
        : "topic/getTableData";
