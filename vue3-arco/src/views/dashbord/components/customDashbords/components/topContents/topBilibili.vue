  ...
  data() {
    return {
      dimension: [
        ...
        { label: "播放", prop: "plays", width: "100px" },
        { label: "弹幕", prop: "danmaku", width: "100px" },
        { label: "收藏", prop: "favorites", width: "100px" },
        { label: "点赞", prop: "likes", width: "100px" },
        { label: "分享", prop: "shares", width: "100px" },
      ],
      commentsPager: {},
      commentsById: {},
    };
